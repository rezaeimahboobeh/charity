...
<li class="imgOutline thumbnail width-90 center">
	...
	<div class="imagecontrol">
		...
		<a class="delete-button" title="<?php echo JText::_('COM_ADVPORTFOLIOPRO_IMAGE_REMOVE'); ?>" href="<?php echo JRoute::_('index.php?option=com_advportfoliopro&task=imagehandler.delete&tmpl=component&image_id=' . $this->image_id . '&rm[]=' . '&rm[]=' . ($this->folder ? $this->folder . '/' : '') . $this->_tmp_img->name); ?>">
